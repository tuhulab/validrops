# graph-conversion / {'label': 'current', 'source_hashes': {'src/validrops/_constants.py': 'd5b85f7e71247b1d', 'src/validrops/tl/_snn.py': 'c0536038a02c3c1b'}, 'harness_hashes': {'benchmarks/_datasets.py': '500d54e5eb650f36', 'benchmarks/_measure.py': 'c4069013023cdbd6', 'benchmarks/run.py': '1efcffac3a1dba0c'}}
...
- timing seconds: median=5.202581, min=5.174394, mad=0.015626, reps=7, CV=0.0053
- peak RSS bytes: worker_max=263028736, unit=bytes
- correctness: pass

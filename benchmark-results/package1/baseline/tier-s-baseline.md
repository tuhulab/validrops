# tier-s / {'label': 'baseline', 'source_hashes': {'src/validrops/_constants.py': 'd5b85f7e71247b1d', 'src/validrops/tl/_snn.py': 'ec34e0600e1820f3', 'src/validrops/tl/expression_metrics.py': 'c3703a43492816a4'}, 'harness_hashes': {'benchmarks/_datasets.py': '500d54e5eb650f36', 'benchmarks/_measure.py': 'c4069013023cdbd6', 'benchmarks/run.py': '1efcffac3a1dba0c'}}
...
- timing seconds: median=4.714611, min=4.697961, mad=0.005998, reps=3, CV=0.0025
- peak RSS bytes: worker_max=283033600, unit=bytes
- correctness: pass
